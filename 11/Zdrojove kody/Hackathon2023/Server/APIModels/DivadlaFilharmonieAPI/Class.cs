namespace Server.APIModels.DivadlaFilharmonieAPI
{

    public class DivadlaFilharmonieAPI
    {
    ...
    public class Properties
    {
        ...
        public string typ_zarizeni { get; set; }
        public string zrizovatel { get; set; }
        public int kapacita { get; set; }
        public string bezbarierovost { get; set; }
        public string typ_bezbarierovosti { get; set; }
